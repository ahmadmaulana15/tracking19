                    ...
                    <form action="{{ route('kasus2.update', $kasus2->id) }}" method="POST">
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"name="jumlah_positif" class="form-control" id="exampleInputEmail1" value="{{ $kasus2->jumlah_positif }}  ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumlah_meninggal" class="form-control" id="exampleInputEmail1" value="{{ $kasus2->jumlah_meninggal}} ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumlah_sembuh" class="form-control" id="exampleInputEmail1" value="{{ $kasus2->jumlah_sembuh }}  ">
